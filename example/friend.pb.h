...
class GetFriendsListServiceRpc : public ::PROTOBUF_NAMESPACE_ID::Service {
 ...
 public:
  ...
  virtual void GetFriendsListLogin(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
...
class GetFriendsListServiceRpc_Stub : public GetFriendsListServiceRpc {
 public:
  ...
  void GetFriendsListLogin(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                       const ::fixbug::GetFriendsListRequest* request,
                       ::fixbug::GetFriendsListResponse* response,
                       ::google::protobuf::Closure* done);
 private:
