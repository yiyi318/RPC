...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "g.ResultCode\022\017\n\007friends\030\002 \003(\0142p\n\030GetFrie"
  "ndsListServiceRpc\022T\n\023GetFriendsListLogin"
...
void GetFriendsListServiceRpc::GetFriendsListLogin(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fixbug::GetFriendsListRequest*,
                         ::fixbug::GetFriendsListResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method GetFriendsListLogin() not implemented.");
  done->Run();
}
...
void GetFriendsListServiceRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
  ...
  switch(method->index()) {
    case 0:
      GetFriendsListLogin(controller,
...
void GetFriendsListServiceRpc_Stub::GetFriendsListLogin(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
